    ...
    public void Dashboard(ActionEvent event) throws Exception {
        ...
        if(contact_no.getText().isEmpty()||userInputtedpassword.getText().isEmpty()){
            ...
            try {
                ...
                con = DriverManager.getConnection("jdbc:mysql://192.168.1.4:3306/blood_group", "Donor", "");
                ...
                if (rs.next()) {
                    ...
                    bloodGroup=rs.getString("BloodGroup"); // mone korsilam vul paisi kintu pai nai ek class a valu jaitese arek class a keno jai na
                ...
                //System.out.println("Error lol " + ex);
            }
            System.out.println("jj "+ userName);
            getUserName();
        }
