...
public class SearchingForRecipent implements Initializable {
   // private Connection con;
    ...
    public void searchingRecipent() {
       // System.out.println("Akaka"+ loginController.getBloodGroup()); //what the okhane kintu shob omnei nisi
            ...
            try {
                ...
                LoginController.con = DriverManager.getConnection("jdbc:mysql://192.168.1.4:3306/blood_group", "Donor", "");
                ...
                while (rs.next()) {
                    ...
                    if (rs.getString("Contact_Number").equals(loginController.getContactNo())) {
                        ...
                        if (rs.getString("BloodGroup").equals(loginController.getBloodGroup())) {//B+ ashtesetana okhane jkhamela abar ja blood grp e
                            notification.setHospital(DashboardController.nameOfHospital);
               ...
               // System.out.println("kololalal" + e);
